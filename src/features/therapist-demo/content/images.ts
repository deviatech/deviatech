...
export const demoImages = {
  ...
  homeApproachA: {
    ...
    width: 4,
    height: 5,
    alt: { en: "Linen textured cushions on a reading chair.", fa: "بالش‌های پارچه‌ای روی یک صندلی مطالعه." },
    placeholder: true,
  },
  homeApproachB: {
    ...
    width: 4,
    height: 3,
    alt: { en: "A cup of tea resting on a wooden side table.", fa: "یک فنجان چای روی میز چوبی کوچک." },
    placeholder: true,
  },
  serviceIndividual: {
    ...
    width: 4,
    height: 3,
    alt: { en: "A single calm chair facing a bright window.", fa: "یک صندلی آرام رو به پنجره‌ای روشن." },
    placeholder: true,
  },
  serviceCouples: {
    ...
    width: 4,
    height: 3,
    alt: { en: "Two chairs angled toward each other in a quiet room.", fa: "دو صندلی رو به هم در فضایی آرام." },
    placeholder: true,
  },
  serviceOnline: {
    ...
    width: 4,
    height: 3,
    alt: { en: "A laptop open on a desk beside a small plant.", fa: "لپ‌تاپ باز روی میز کنار یک گیاه کوچک." },
    placeholder: true,
  },
  serviceGroup: {
    ...
    width: 4,
    height: 3,
    alt: { en: "A circle of chairs arranged in a bright room.", fa: "چیدمان دایره‌ای صندلی‌ها در اتاقی روشن." },
    placeholder: true,
  },
  aboutHero: {
    ...
    width: 4,
    height: 5,
    alt: { en: "A calm consulting room with soft daylight.", fa: "اتاق مشاوره‌ای آرام با نور روز ملایم." },
    placeholder: true,
  },
  individualHero: {
    ...
    width: 4,
    height: 5,
    alt: { en: "A sunlit room prepared for a one-to-one session.", fa: "اتاقی آفتاب‌گیر آماده برای جلسه فردی." },
    placeholder: true,
  },
  individualOutcomeA: {
    ...
    width: 4,
    height: 5,
    alt: { en: "Notebook and pen resting on a linen chair.", fa: "دفترچه و خودکار روی صندلی پارچه‌ای." },
    placeholder: true,
  },
  individualOutcomeB: {
    ...
    width: 4,
    height: 3,
    alt: { en: "Soft daylight through a linen curtain.", fa: "نور ملایم روز از پشت پرده‌ای کتانی." },
    placeholder: true,
  },
  couplesHero: {
    ...
    width: 4,
    height: 5,
    alt: { en: "Two chairs facing each other in a warm-lit room.", fa: "دو صندلی رو به هم در اتاقی با نور گرم." },
    placeholder: true,
  },
  couplesOutcomeA: {
    ...
    width: 4,
    height: 5,
    alt: { en: "Two cups of tea on a shared table.", fa: "دو فنجان چای روی میزی مشترک." },
    placeholder: true,
  },
  couplesOutcomeB: {
    ...
    width: 4,
    height: 3,
    alt: { en: "A quiet corner with two seats and soft light.", fa: "گوشه‌ای آرام با دو صندلی و نور ملایم." },
    placeholder: true,
  },
  blogHero: {
    ...
    width: 16,
    height: 9,
    alt: { en: "An open notebook beside a warm cup of tea.", fa: "دفترچه‌ای باز کنار فنجان چای گرم." },
    placeholder: true,
  },
  contactHero: {
    ...
    width: 4,
    height: 3,
    alt: { en: "A welcoming waiting area with natural light.", fa: "فضای انتظاری دلنشین با نور طبیعی." },
    placeholder: true,
  },
  bookingHero: {
    ...
    width: 4,
    height: 5,
    alt: { en: "A calm room prepared for a first conversation.", fa: "اتاقی آرام آماده برای اولین گفتگو." },
    placeholder: true,
  },
